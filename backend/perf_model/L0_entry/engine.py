...
def run_evaluation(
    ...
    from perf_model.L5_reporting.engine import ReportingEngine
...
def _build_hardware_spec(chip: Any, eval_config: EvalConfig) -> dict[str, Any]:
    ...
    """
    from perf_model.L4_evaluation.common.metrics import CommProtocolSpec, HardwareSpec, merge_specs
...
def _calculate_memory_breakdown(
    ...
    """
    import logging
    from perf_model.L5_reporting.memory_analysis import MemoryAnalyzer
...
def run_evaluation_from_request(
    ...
    try:
        ...
        from perf_model.L0_entry.compat import (
        ...
        if step_metrics_objects:
            from perf_model.L5_reporting.traffic_analysis import TrafficAnalyzer as TA
...
def _calculate_deployment_cost(
    ...
    Returns:
        dict: 成本分析结果
    """
    from perf_model.L5_reporting.cost_analysis import CostAnalyzer
