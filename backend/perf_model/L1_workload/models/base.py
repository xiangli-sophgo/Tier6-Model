...
from perf_model.L1_workload.graph import GraphEdge, GraphNode, NodeKind, NodeRole, WorkloadGraph
from perf_model.L1_workload.layer import Layer, Module
from perf_model.L1_workload.metadata import ModelMetadata
from perf_model.L1_workload.tensor import TensorDesc

if TYPE_CHECKING:
    from perf_model.L1_workload.ir import WorkloadIR
    from perf_model.L1_workload.layers.base import LayerBase
...
class ModelBase(ABC):
    ...
    def to_ir(self) -> "WorkloadIR":
        ...
        """
        from perf_model.L1_workload.ir import Model
