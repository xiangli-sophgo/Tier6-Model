...
from perf_model.L1_workload.models import model_registry
...
class DeepSeekV3Model(ModelBase):
    ...
    def from_model_config(cls, mc: "ModelConfig") -> DeepSeekV3Model:
        ...
        Args:
            mc: 类型化模型配置 (from perf_model.L0_entry.eval_config)

        Returns:
            DeepSeekV3Model 实例
        """
        from perf_model.L0_entry.eval_config import ModelConfig  # noqa: F811
        config = {
