...
if TYPE_CHECKING:
    ...
    from perf_model.L3_mapping.common.plan.distributed_model import DistributedOp
...
class AttentionPreciseEvaluator:
    ...
    def evaluate(
        ...
        """
        from perf_model.L4_evaluation.math.evaluators.softmax_eval import (
...
class RMSNormPreciseEvaluator:
    ...
    def evaluate(
        ...
        """RMSNorm 精评估（9步向量操作）"""
        from perf_model.L4_evaluation.math.evaluators.rmsnorm_eval import (
